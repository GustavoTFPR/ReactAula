...
// Junte tudo num Mural estático: um Header, um Contador, vários cards com nomes reais diferentes e um Rodape.
// Repare: repetimos muito código só pra trocar o nome — a Aula 12 resolve isso com props.
...
export default function MuralDaTurma() {
    return (
