...
// Enunciado: Mostrar erro na tela
// Em vez de alert, use um estado erro. Se o nome for vazio, setErro("Nome obrigatório") em vermelho; senão limpa o erro.

"use client";

import { useState } from "react";

export default function MostrarErroNaTela() {
    ...
    return (
        <form
            ...
            <button
                type="submit"
                className="mt-3 inline-flex items-center justify-center rounded-lg bg-zinc-900 px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors hover:bg-zinc-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900 focus-visible:ring-offset-2 active:scale-[0.98]">
                enviar
            </button>
            {enviado && (
                <div className="mt-3 rounded-lg border border-zinc-100 bg-zinc-50 px-4 py-2.5 text-sm text-zinc-700">
                    Cadastrado: {enviado}
                </div>
            )}
        </form>
